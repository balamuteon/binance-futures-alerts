...
export const options = {
  ...
  stages: [
    { duration: '10s', target: 10 },    // За 1 минуту быстро доходим до 5k
    { duration: '5s', target: 10 },   // За следующие 2 минуты добираемся до 20k
    // { duration: '3m', target: 50000 },   // За 3 минуты выходим на пик в 50k
    // { duration: '2m', target: 50000 },   // 2 минуты держим максимальную нагрузку
    { duration: '5s', target: 0 },       // Плавно снижаем нагрузку
  ],
